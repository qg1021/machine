...
function login() {
    location.href = "https://passport.360buy.com/new/login.aspx?ReturnUrl=" + escape(location.href).replace(/\//g, "%2F");
    return false;
...
function search(h) {
    var p = "http://search.360buy.com/Search?keyword={keyword}&enc={enc}{additional}{area}";
    var b = "";
    ...
    switch (i) {
        ...
        p = "http://search.e.360buy.com/searchDigitalBook?ajaxSearch=0&enc=utf-8&key={keyword}&page=1{additional}";
        break;
        default:
        break;
