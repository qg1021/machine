...
import com.gm.machine.api.NewsDao;
import com.gm.machine.entity.News;
 ...
 */
@Component
public class NewsHibernateDao extends HibernateDao<News, Long> implements
NewsDao
{
     ...
     * 
     * @since 2012-7-28
     * @see com.gm.bamboo.api.NewsDao#publish(java.util.List, java.lang.Boolean)
     */
    @Override
    public void publish(List<Long> ids, Boolean isPublish)
    {
        String hql = "update News set ispublish = :ispublish , publishdate = :publishdate where id in(:ids)";
