 ...
 */
@Namespace("/backend")
@Results( { @Result(name = CrudActionSupport.RELOAD, location = "links.action?mtype=${mtype}", type = "redirect") })
public class LinksAction extends CrudActionSupport<Links>
{
    ...
    private Page<Links>       page             = new Page<Links>(10);
    ...
    {
        return Global.linksTypeList.get(mtype);
    }
    ...
    public String cancelPublish() throws Exception
    {
        try
        {
            linksManager.cancelPublish(ids);
