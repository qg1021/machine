 ...
 */
@Component
public class PostHibernateDao extends HibernateDao<Post, Long> implements
PostDao
{
    /**
     * {@inheritDoc}
    ...
    {
        String hql = "delete from Post where id in(:ids)";
    ...
    {
        String hql = "update Post set status = :status where id in(:ids)";
