 ...
 */
@Namespace("/user")
@Results( { @Result(name = CrudActionSupport.RELOAD, location = "enquiry!input.action?id=${parentid}&pid=${pid}", type = "redirect") })
public class EnquiryAction extends CrudActionSupport<Enquiry>
{
    ...
    private Page<Enquiry>     page             = new Page<Enquiry>(5);
    @Autowired
    ...
    public String save() throws Exception
    {
        ...
        entity.setUser(user);
        entity.setContent(CommonUtils.escapeHTMLTags(Struts2Utils
                .getParameter("remark")));
