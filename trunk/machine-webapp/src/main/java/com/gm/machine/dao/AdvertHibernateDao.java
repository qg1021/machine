 ...
 */
@Component
public class AdvertHibernateDao extends HibernateDao<Advert, Long> implements
AdvertDao
{
    /**
     * {@inheritDoc}
    ...
    {
        String hql = "update Advert set ispublic = :ispublic ,pubdate =:pubdate where id in(:ids)";
