...
<head>  
	...
	<meta content="my_enquiry" name="activemenu" />
...
<div class="w main">
	...
	<div class="right">
		<div class="o-mt"><h2>我的询价</h2></div>
		<form id="mainForm" action="enquiry.action" method="post">
						...
						<table width="100%" cellspacing="0" cellpadding="0" border="0">
							...
							<s:iterator value="page.result">
								<tr>
									...
									<td>
										<a href="enquiry!input.action?id=${id}&pid=${productid}">
											查看询价回复
										</a>
									</td>
								</tr>
