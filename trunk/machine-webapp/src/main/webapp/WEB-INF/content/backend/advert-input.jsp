	...
	<div id="fullbg"></div> 
		...
		<div id="content"> 
		    ...
		    <div class="mainpart">
    			...
    			<div class="detailbox">
				<form id="inputForm" name="inputForm" action="advert!save.action?mtype=${mtype}" method="post">
			    	...
			    	<ul>
						...
						<li>
				  		...
				  		<li>
				  			...
				  			<input id="linkurl" name="linkurl" value="${linkurl}" type="text" maxlength="100" style="width:400px;" />
				  		</li>
				  		<li>
				  			<label>配图</label>
	 				...
	 				<div class=" buttonbox lh32 tc">
							...
							<input class="button02 w60 rr ml20" type="button" type="button" onclick="location.href='advert.action?mtype=${mtype}'" value="取消" />
                    </div>
	 			</form>
 			</div>
 			</div>
